...
<!-- /.box-header -->
          <div class="box-body">
            ...
            <div class="">
              ...
              <tbody>
                <?php $__currentLoopData = $data_pelayan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelayan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

              <tr role="row" class="odd">
                <td class="sorting_1"><?php echo e($pelayan->nama_pelayan); ?></td>
                <td> <?php echo e($pelayan->kode_pelayan); ?></td>
                <td> <?php echo e($pelayan->jk); ?></td>
                <td> <?php echo e($pelayan->umur); ?></td>
                <td> <?php echo e($pelayan->agama); ?></td>
                <td> <?php echo e($pelayan->alamat); ?></td>
                <td> <?php echo e($pelayan->tlp); ?></td>
                <td>
                  <a href="\pelayan\<?php echo e($pelayan->id); ?>/edit" class="btn btn-warning btn-sm">edit</a>
                  <a href="\pelayan\<?php echo e($pelayan->id); ?>/delete" class="btn btn-danger btn-sm" onclick="return confirm('Data Akan Dihapus Lanjutkan')">Hapus</a>
                </td>
              </tr>
...
<?php $__env->startSection('content2'); ?>
        ...
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
            ...
            <?php $__currentLoopData = $data_pelayan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelayan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td> <?php echo e($pelayan->nama_pelayan); ?></td>
                <td> <?php echo e($pelayan->kode_pelayan); ?></td>
                <td> <?php echo e($pelayan->jk); ?></td>
                <td> <?php echo e($pelayan->umur); ?></td>
                <td> <?php echo e($pelayan->agama); ?></td>
