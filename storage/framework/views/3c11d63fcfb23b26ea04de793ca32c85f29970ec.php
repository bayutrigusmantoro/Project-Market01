  <?php $__env->startSection('content'); ?>
    ...
    <!-- /.box-header -->
            ...
            <?php $__currentLoopData = $data_kasir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kasir): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td> <?php echo e($kasir->nama_kasir); ?></td>
                <td> <?php echo e($kasir->kode_kasir); ?></td>
                  <td> <?php echo e($kasir->jk); ?></td>
                    <td> <?php echo e($kasir->umur); ?></td>
                    <td> <?php echo e($kasir->agama); ?></td>
                  <td> <?php echo e($kasir->alamat); ?></td>
                <td> <?php echo e($kasir->tlp); ?></td>
              <td>
                <a href="\kasir\<?php echo e($kasir->id); ?>/edit" class="btn btn-warning btn-sm">edit</a>
                <a href="\kasir\<?php echo e($kasir->id); ?>/delete" class="btn btn-danger btn-sm" onclick="return confirm('Data Akan Dihapus Lanjutkan')">Hapus</a>
              </td>
            </tr>
            </thead>
