    ...
    <!-- /.box-header -->
          ...
          <table class="table table-bordered table-striped dataTable">
             <thead class="thead-dark">
              ...
              <?php $__currentLoopData = $data_minum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $minum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td> <?php echo e($minum->nama_minum); ?></td>
                  <td> <?php echo e($minum->kode_minum); ?></td>
                  <td> <?php echo e($minum->harga_beli); ?></td>
                  <td> <?php echo e($minum->harga_jual); ?></td>
                  <td> <?php echo e($minum->jumlah); ?></td>
                  <td> <?php echo e($minum->sisa); ?></td>
                  <td>
                    <a href="\minum\<?php echo e($minum->id); ?>/edit" class="btn btn-warning btn-sm">edit</a>
                    <a href="\minum\<?php echo e($minum->id); ?>/delete" class="btn btn-danger btn-sm" onclick="return confirm('Data Akan Dihapus Lanjutkan')">Hapus</a>
                  </td>
                </tr>
                </thead>
